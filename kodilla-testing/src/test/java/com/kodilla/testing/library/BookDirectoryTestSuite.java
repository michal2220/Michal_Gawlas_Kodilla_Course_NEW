...
class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("Tests for list of books")
    class ListOfBooks {
    ...
    @Nested
    @DisplayName("Tests for quantity of books")
    class QuantityOfBooks {


        @Test
        void testListBooksInHandsOf_NoBorrowedBooks(){

            //Given

            LibraryUser libraryUser = new LibraryUser("a","b","123");
        ...
        @Test
        void testListBooksInHandsOf_OneBorrowedBooks(){
        ...
        @Test
        void testListBooksInHandsOf_FiveBorrowedBooks(){
            ...
            Book book3 = new Book("Secret life of programmers", "Steve Wolkowitz", 2016);
            Book book4 = new Book("Secrets of Java", "Ian Tenewitch", 2010);
            Book book5 = new Book("a of Java", "Ian a", 2011);
            resultListOfBooks.add(book1);
